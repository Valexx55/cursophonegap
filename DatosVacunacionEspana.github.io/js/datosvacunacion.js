...
function dibujarGraficoMadridRecibidas2(ultimas8_fechas_Madrid, ultimas8_dosis_Madrid ) {
    ...
    dibujargraficaBarrasVertical(ctx, ultimas8_fechas_Madrid.reverse(), ultimas8_dosis_Madrid.reverse(), 'rgb(16, 26, 214)', 'RECIBIDAS');
...
function dibujarGraficoMadridAdministradas2(fechas, datos) {
    ...
    dibujarGraficaLinea(ctx, fechas.reverse(), datos.reverse(), 'rgb(226, 83, 3)', 'ADMINISTRADAS');
...
function dibujarGraficoMadridPautaCompleta2(fechas, datos) {
    ...
    dibujarGraficaLinea(ctx, fechas.reverse(), datos.reverse(), 'rgb(83, 225, 162)', 'INMUNIZADAS');
}
...
function dibujarGraficoDosisEntregadasEspana2(fechas, datos) {
   ...
   // let ultimos7_registros_dosis_Entregadas_Espania = ultimos7_datos_Espania.map(registro => registro[POS_DOSIS_ENTREGADAS]);
    ...
    dibujargraficaBarrasVertical (ctx, fechas.reverse(), datos.reverse(), 'rgb(16, 26, 214)', 'RECIBIDAS');
...
function mostrarSeccionCCAA(datos) {
    ...
    dibujargraficaBarras(ctx1, ccaa, dosis_entregadas, 'rgb(16, 26, 214)', 'RECIBIDAS');
    ...
    dibujargraficaBarras(ctx3, ccaa, dosis_adminx2, 'rgb(83, 225, 162)', "INMUNIZADAS");
}
