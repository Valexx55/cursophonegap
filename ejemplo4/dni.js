...
function calcularLetraDni ()
{
    ...
    //parseInt
    console.log (l.value);
    let dniletra = l.value + "" + dni;
    console.log("dni_letra = " +dniletra);
    console.log(dniletra);
    console.log("TIPO DNILETRA = " + typeof dniletra);
    let dni_numero = parseInt(dniletra);
    console.log("TIPO DNI_NUMERO = " + typeof dni_numero);
    var resto = (dni_numero % 23);
    let letradni = LETRAS_DNI.charAt(resto);
    //CREAR UN NUEVO ELEMENTO
